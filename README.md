...
<div align="center">
<img width="100%" src="http://drive.google.com/uc?export=view&id=1NQIcH1GnyQ6MK3aCALhaGIWIiAVkwap9">
</div>

En esta estructura he utilizado escasas etiquetas para disponer los datos,(16 etiquetas en total), utilizando los atributos en cada etiqueta, teniendo en cuenta la promoción en el curso, las asignaturas, su nombre y sus horas semanales. En los alumnos, hay dos matriculados, indicando su nombre y apellidos, NIF, contactos, direcciones, faltas y calificaciones. Por último indiqué el inicio y el final del curso con: día, mes y año.
